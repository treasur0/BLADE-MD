...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER || '2349015010957'  // Make SURE its Not Be Empty, Else Bot Stoped And Errors,
global.mongodb = process.env.MONGODB_URI || "mongodb+srv://ahil1:787191784abhi@ahil1.kzr1tt3.mongodb.net/?retrywrites=true&w=majority"
global.port= process.env.PORT || 5000
global.email = 'dsoul9588@gmail.com'
global.github = 'https://github.com/Bladeh4x/BLADE-MD'
global.location = 'Lahore pakistan'
global.gurl = 'https://instagram.com/tdpromoterr/' // add your username
global.sudo = process.env.SUDO || "2349015010957"
...
module.exports = {
  ...
  packname:  process.env.PACK_NAME || 'MADE BY IN2TECH',
  
  botname:   process.env.BOT_NAME === undefined ? "SCOTT-MD" : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'SCOTT' : process.env.OWNER_NAME,  
